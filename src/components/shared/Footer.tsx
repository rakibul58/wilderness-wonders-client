      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-secondary">
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          <p className="text-sm text-gray-100">
            © Copyright 2024 Wilderness Wonders. All rights reserved.
          </p>
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            ...
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="text-background h-6 hover:text-accent-foreground"
              >
            ...
            >
              <svg
                viewBox="0 0 30 30"
                fill="currentColor"
                className="h-6 text-background hover:text-accent-foreground"
              >
            ...
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="h-5 text-background hover:text-accent-foreground"
              >
